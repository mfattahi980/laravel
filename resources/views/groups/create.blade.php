            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-info">
                        <div class="card-body">
                            <form action="/groups/create" method="post" class="border p-4 rounded">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="name" type="text" class="form-control" id="groupname" placeholder="Enter Your Group Name">
                                    </div>
                                </div>
